...
def get_vidswin_model(args):
    if int(args.size_img) == 384 and args.vis_backbone_size == "large":
        # assert args.vis_backbone_size == "large"
        config_path = './videoQA/visbackbone/swin_%s_384_patch244_window81212_kinetics600_22k.py' % (args.vis_backbone_size)
        if args.vis_backbone_init == "2d":
            model_path = f'./videoQA/models/swin_transformer/swin_{backbone_size}_patch4_window12_384_22k.pth'
        else:
            model_path = './videoQA/models/video_swin_transformer/swin_%s_384_patch244_window81212_kinetics%s_22k.pth' % (args.vis_backbone_size, args.kinetics)
    elif args.vis_backbone_size  not in ["tiny", "violet"]:
        # assert args.size_img == 224
        config_path = './videoQA/visbackbone/swin_%s_patch244_window877_kinetics400_22k.py' % (args.vis_backbone_size)
        if args.vis_backbone_init == "2d":
            model_path = './videoQA/models/swin_transformer/swin_%s_patch4_window7_224_22k.pth' % (args.vis_backbone_size)
        else:
            model_path = './videoQA/models/video_swin_transformer/swin_%s_patch244_window877_kinetics%s_22k.pth' % (args.vis_backbone_size, args.kinetics)
    elif args.vis_backbone_size == "tiny":
        # tiny
        assert args.size_img == 224
        config_path = './videoQA/visbackbone/swin_%s_patch244_window877_kinetics400_1k.py' % (args.vis_backbone_size)
        if args.vis_backbone_init == "2d":
            model_path = './videoQA/models/swin_transformer/swin_%s_patch4_window7_224.pth' % (args.vis_backbone_size)
        else:
            model_path = './videoQA/models/video_swin_transformer/swin_tiny_patch244_window877_kinetics400_1k.pth'
    else:
        assert args.vis_backbone_size == "violet"
        config_path = 'videoQA/visbackbone/swin_violet_patch244_window877.py'
        # if args.vis_backbone_init2d_init"]:
        #     model_path = './models/swin_transformer/swin_%s_patch4_window7_224.pth' % (args.vis_backbone_size)
        # else:
        model_path = None
